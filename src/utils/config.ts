...
export const networkConfigs: Record<NetworkType, ConfigData> = {
  mainnet: {
    networkType: 'mainnet',
    unisatWalletUri: 'https://wallet-api.unisat.io',
    mempoolUri: 'https://mempool.space',
    network: bitcoin.networks.bitcoin,
  },
  testnet: {
    networkType: 'testnet',
    unisatWalletUri: 'https://wallet-api-testnet.unisat.io',
    mempoolUri: 'https://mempool.space/testnet',
    network: bitcoin.networks.testnet,
  },
  testnet4: {
    networkType: 'testnet4',
    unisatWalletUri: 'https://wallet-api-testnet4.unisat.io',
    mempoolUri: 'https://mempool.space/testnet4',
    network: bitcoin.networks.testnet,
  },
  signet: {
    networkType: 'signet',
    unisatWalletUri: 'https://wallet-api-signet.unisat.io',
    mempoolUri: 'https://mempool.space/signet',
    network: bitcoin.networks.testnet,
  },
  fractal: {
    networkType: 'fractal',
    unisatWalletUri: 'https://wallet-api-fractal.unisat.io',
    mempoolUri: 'https://mempool.fractalbitcoin.io',
    network: bitcoin.networks.bitcoin,
  },
  'fractal-testnet': {
    networkType: 'fractal-testnet',
    unisatWalletUri: 'https://wallet-api-fractal-testnet.unisat.io',
